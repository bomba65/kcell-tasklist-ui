...
public class CorrectJrBlankController {
    ...
    public ResponseEntity<String> migrateFiles(HttpServletRequest request){
        ...
        List<String> list = Arrays.asList(
            "6c3a08a4-0eb6-11e9-a6e7-0242ac12000a",
            "38f1beac-22b6-11e9-9a55-0242ac12000a",
            "4c109c25-22b6-11e9-9a55-0242ac12000a",
            "6daf7c0e-22b6-11e9-9a55-0242ac12000a",
            "3db1dd9a-1495-11e9-a90d-0242ac12000a"
        );

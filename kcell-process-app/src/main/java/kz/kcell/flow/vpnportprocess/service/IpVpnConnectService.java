...
public class IpVpnConnectService {
    ...
    public String addNewVlanToIpVpnConnectFile(String serviceType) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed addNewVlanToIpVpnConnectFile", e);
        }
    }
    ...
    public Pair<String, Integer> addNewVpnToIpVpnConnectFile(VpnOutputDto vpn, String serviceType, String vlan) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed addNewVpnToIpVpnConnectFile", e);
        }
    }
    ...
    public void changeAddedServiceStatus(VpnCamVar vpn, Pair<String, Integer> rowNumber, String status) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed changeAddedServiceStatus", e);
        }
    }
    ...
    public void changeStatusAndCapacity(String vpnNumber, String status, Integer modifiedCapacity) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed changeStatusAndCapacity", e);
        }
    }
    ...
    public void changeStatusAndCapacityVpn(String portNumber, String status, Integer modifiedCapacity) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed changeStatusAndCapacityVpn", e);
        }
    }
    ...
    public boolean checkUtilization(String vpnNumber, String serviceType) {
        try (InputStream in = sambaService.readIpVpnStatistics()) {
            ...
            throw new RuntimeException("Failed checkUtilization", e);
        }
    }
    ...
    public Map<String, Double> findVpnNumbersThatMeetUtilizationCriteria() {
        try (InputStream in = sambaService.readIpVpnStatistics()) {
            ...
            log.info("findVpnNumbersThatMeetUtilizationCriteria result: " + objectMapper.writeValueAsString(result));
            return result;
        } catch (IOException e) {
            throw new RuntimeException("There is problem occurred while fetching data from IP VPN Statistics", e);
        }
    }
    ...
    public void makeChangesToAddedService(VpnOutputDto vpn, Pair<String, Integer> rowNumber) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed makeChangesToAddedService", e);
        }
    }
    ...
    public void deleteAddedService(VpnCamVar vpn, Pair<String, Integer> rowNumber) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed deleteAddedService", e);
        }
    }
    ...
    public void deleteDisbandedVpn(String vpnNumber) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed deleteDisbandedVpn", e);
        }
    }
    ...
    public void changePortCapacity(String portNumber, String portCapacity, String status) {
        try (InputStream in = sambaService.readIpVpnConnect()) {
            ...
            throw new RuntimeException("Failed changePortCapacity", e);
        }
    }

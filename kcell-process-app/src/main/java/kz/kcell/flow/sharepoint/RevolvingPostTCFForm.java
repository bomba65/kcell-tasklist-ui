...
public class RevolvingPostTCFForm implements JavaDelegate {
    ...
    @Autowired
    public RevolvingPostTCFForm(@Value("${sharepoint.forms.url:https://sp19.kcell.kz/forms/_api}") String baseUri, @Value("${sharepoint.forms.username}") String username, @Value("${sharepoint.forms.password}") String pwd,

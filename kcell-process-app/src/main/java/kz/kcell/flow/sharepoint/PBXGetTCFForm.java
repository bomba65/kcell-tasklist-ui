...
public class PBXGetTCFForm implements JavaDelegate {
    ...
    @Autowired
    public PBXGetTCFForm(@Value("${sharepoint.forms.url:https://sp19.kcell.kz/forms/_api}") String baseUri, @Value("${sharepoint.forms.username}") String username, @Value("${sharepoint.forms.password}") String pwd,

...
public class ChangeStartTime implements ExecutionListener {
    ...
    public void notify(DelegateExecution execution) throws Exception {
        ...
        if (execution.hasVariable("contractor") && execution.getVariable("contractor").toString().equals("4")) {
            execution.setVariable("validityDate", new SimpleDateFormat("dd.MM.yyyy").parse("30.06.2020"));
            execution.setVariable("requestedDate", new SimpleDateFormat("dd.MM.yyyy").parse("30.06.2020"));

...
//        println(result)
    ...
    static String gest (Object object){
        println(object.cn_addr_city);
        println(object.cn_sitename);
    }
                ...
                for(int i = 1;i <= cycleCount;i++){
                        ...
                        table(class:"table", border:"1") {
                            tr {
                                ...
                                for(int j =1;j<3;j++){
                                    td (width:"25%",style:"background-color:#8b8e94", "")
                                }
                            }
                            tr {
...
//        def String[] antennaNames = ['G900', 'G1800', 'U900', 'U2100', 'L800', 'L1800','L2100', 'L2600']
        ...
        for (int j =0;j<cycle;j++){
            ...
            for(String item : antennaNames){
                println(item)
                if(antennaItem.containsKey(item)){
                    println('YES')

                    println(antennaItem[item])
                } else {
                    println('NO')

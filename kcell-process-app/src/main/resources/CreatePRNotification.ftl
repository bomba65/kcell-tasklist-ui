...
<table>
    <tr>
        <td><b>Initiator</b>: ${initiatorFullObj.firstName} ${initiatorFullObj.lastName}</td>
        <td><b>JR Number</b>: ${jrNumber}</td>
        <td></td>
    </tr>
    <tr>
        <td><b>Requested date</b>: ${requestedDate?string["dd.MM.yyyy HH:mm"]}</td>
        <td><b>Reason</b>: ${reasonsTitle[reason]}</td>
        <td><b>Materials required</b>: ${materialsRequired}</td>
    </tr>
    <tr>
        <td><b>Validity date</b>: ${validityDate?string["dd.MM.yyyy"]}</td>
        <td><b>Contract</b>: ${servicesTitle[contract?c]}</td>
        <td><b>Leasing required</b>: ${leasingRequired}</td>
    </tr>
    <tr>
        <td><b>SA&O Complaint Id</b>: ${soaComplaintId}</td>
        <td><b>Contractor</b>: ${contractorsTitle[contractor?c]}</td>
        <td><b>Site (near end)</b>: ${siteName}</td>
    </tr>
    <tr>
        <td><b>Power engineering required</b>: ${powerRequired}</td>
        <td><b>Project</b>: ${project}</td>
        <td><b>Site Name</b>: ${site_name}</td>
    </tr>
    <tr>
        <td><b>Works</b>:</td>
        <td></td>

...
def ne_power_level_tx = "-23.1"
def fe_power_level_tx = "-23.1"
...
def binding = ["tnuTsdNumber":tnuTsdNumber,"ne_longitude":ne_longitude.replace(".",","),"fe_longitude":fe_longitude.replace(".",","),
               ...
               "ne_power_level_tx":ne_power_level_tx.replace(".",","),"fe_power_level_tx":fe_power_level_tx.replace(".",","),
               "ne_sitename":ne_sitename,"fe_sitename":fe_sitename,"ne_azimuth":ne_azimuth.replace(".",","),"fe_azimuth":fe_azimuth.replace(".",","),
               "ne_construction_height":ne_construction_height.replace(".",","), "fe_construction_height":fe_construction_height.replace(".",",")]

def template = '''\
yieldUnescaped '' + tnuTsdNumber + ';' + tnuTsdNumber + ';' + ne_longitude + ';' + fe_longitude + ';' + ne_latitude + ';' + fe_latitude + ';'
+ ne_power_level_tx + ';' + fe_power_level_tx + ';' + ne_sitename + ';' + fe_sitename + ';' + ne_azimuth + ';' + fe_azimuth + ';' + ne_construction_height + ';'

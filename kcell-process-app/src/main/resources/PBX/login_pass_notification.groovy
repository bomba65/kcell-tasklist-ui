...
html(lang:'en') {
    ...
    body {
        ...
        newLine()
        p('Просим вас сообщить о факте готовности к тестированию на почтовый адрес Anatoliy.Khan@kcell.kz или по номеру +7 701 2118277.')
        newLine()
...
html(lang:'en') {
    ...
    body {
        ...
        newLine()
        p('Для вас на время тестирования прописаны исходящие наборы только на номер +7 701 211 1441 Евгений.')
        newLine()

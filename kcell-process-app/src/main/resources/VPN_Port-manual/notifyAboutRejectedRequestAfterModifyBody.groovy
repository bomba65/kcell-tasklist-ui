...
def initiator_comments = execution.getVariable("initiator_comments").toString()
...
def binding = ["request_number"  : request_number,
               ...
               "initiator"          : initiator,
               "initiator_comments"  : initiator_comments]
...
html(lang:'ru') {
    ...
    body {
        p { 
            yield "Запрос # " + request_number + " на " + request_type_rus + " " + channel_rus + " отклонен по следующей причине: " + initiator_comments
        }
        br()
        p {

...
def initiatorComments = execution.getVariable("modifyFormTaskComment").toString()
...
html(lang:'ru') {
    ...
    body {
        p { 
            yield "Запрос # " + request_number + " на " + request_type_rus + " " + channel_rus + " отклонен по следующей причине: " + initiatorComments
        }
        br()
        p {

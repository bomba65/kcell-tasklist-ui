...
public class ExternalIdentityProviderPlugin extends LdapConfiguration implements ProcessEnginePlugin {

    protected Logger LOG = Logger.getLogger(ExternalIdentityProviderPlugin.class.getName());

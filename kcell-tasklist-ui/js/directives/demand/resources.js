        ...
        return {
            ...
            link: function(scope, el, attrs) {
                ...
                scope.catalogs = {
                    "Kcell staff": {
                        "CPD": [
                          {v: "Administrator", expert: {groupId: 'DEMAND_CPD_L2_ANTENNAS'}, needCheck: true},
                          {v: "Chancellery Senior Administrator", expert: {groupId: 'DEMAND_CPD_L2_CABLE_MATERIALS'}, needCheck: true},
                          {v: "ata Input Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Director", expert: {groupId: ''}, needCheck: true},
                          {v: "Expert", expert: {groupId: ''}, needCheck: true},
                          {v: "Fleet Management Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "General Warehouse Senior Administrator", expert: {groupId: ''}, needCheck: true},
                          {v: "Head", expert: {groupId: ''}, needCheck: true},
                          {v: "Intern", expert: {groupId: ''}, needCheck: true},
                          {v: "Logistics Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Manager", expert: {groupId: ''}, needCheck: true},
                          {v: "Master Data Senior Administrator", expert: {groupId: ''}, needCheck: true},
                          {v: "Monitoring and Optimization Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Monitoring and Optimization Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Processes Support Expert", expert: {groupId: ''}, needCheck: true},
                          {v: "Senior Administrator", expert: {groupId: ''}, needCheck: true},
                          {v: "Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Sourcing Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Sourcing Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Supervisor", expert: {groupId: ''}, needCheck: true},
                          {v: "Travel Management Senior Administrator", expert: {groupId: ''}, needCheck: true},
                        ...
                        "CEO": [
                          {v: "Adviser-Consultant", expert: {groupId: ''}, needCheck: true},
                          {v: "Assistant", expert: {groupId: ''}, needCheck: true},
                          {v: "Corporate Social Responsibility Projects Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Due Diligence Expert", expert: {groupId: ''}, needCheck: true},
                          {v: "Due Diligence Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Due Diligence Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Ethics and Compliance Officer", expert: {groupId: ''}, needCheck: true},
                          {v: "Expert", expert: {groupId: ''}, needCheck: true},
                          {v: "Intern", expert: {groupId: ''}, needCheck: true},
                          {v: "Investor Relations Expert", expert: {groupId: ''}, needCheck: true},
                          {v: "Manager", expert: {groupId: ''}, needCheck: true},
                          {v: "Public Relations Junior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Public Relations Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Senior Specialist", expert: {groupId: ''}, needCheck: true},
                          {v: "Chief Executive Officer", expert: {groupId: ''}, needCheck: true},
                          {v: "Corporate Secretary", expert: {groupId: ''}, needCheck: true},
                          {v: "New role", expert: {groupId: ''}, needCheck: true}
                        ],
                        "B2C": [

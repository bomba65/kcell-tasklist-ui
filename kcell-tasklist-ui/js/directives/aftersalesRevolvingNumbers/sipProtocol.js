define(['./../module'], function(module){
    'use strict';
    module.directive('aftersalesRevolvingNumbersSipProtocol', function ($rootScope, $http, $timeout) {
        return {
            restrict: 'E',
            scope: {
                data: '=',
            ...
            templateUrl: './js/directives/aftersalesRevolvingNumbers/sipProtocol.html'
        };
    });
});
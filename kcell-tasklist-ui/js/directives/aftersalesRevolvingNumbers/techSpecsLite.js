define(['./../module'], function(module){
    'use strict';
    module.directive('aftersalesRevolvingNumbersTechnicalSpecificationsLite', function ($rootScope, $http, $timeout) {
        return {
            restrict: 'E',
            scope: {
                datatech: '=',
            ...
            link: function(scope, element, attrs) {
                scope.$watch('datatech', function (value) {
                    if (value) {
                        if (!scope.datatech.iCallAccess) scope.datatech.iCallAccess = 'No';
            ...
            templateUrl: './js/directives/aftersalesRevolvingNumbers/techSpecsLite.html'
        };
    });
});
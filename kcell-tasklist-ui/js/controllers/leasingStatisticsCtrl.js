define(['./module','jquery'], function(app,$){
	'use strict';
	return app.controller('leasingStatisticsCtrl', ['$scope', '$rootScope', '$filter', '$http', '$state', '$stateParams', '$q', '$location', 'AuthenticationService',
			                         function($scope,   $rootScope, $filter, $http, $state,  $stateParams,   $q, $location, AuthenticationService) {

		$rootScope.currentPage = {
			name: 'leasingStatistics'
		};
		...
		$scope.reportsMap = {
            ...
            'leasing': {name: 'Rollout Leasing process', process: 'leasing'},
        ...
        $scope.getProcessDefinition = function(){
            ...
            } else if($scope.currentReport === 'leasing'){
                return 'leasing';
            }
        }

define(['./module', 'camundaSDK', 'lodash', 'big-js', 'jquery', 'moment'], function (module, CamSDK, _, Big, $, moment) {
    ...
    return module.controller('mainCtrl', ['$scope', '$rootScope', 'toasty', 'AuthenticationService', '$routeParams', '$timeout', '$location', 'exModal', '$http', '$state', 'StartProcessService', function ($scope, $rootScope, toasty, AuthenticationService, $routeParams, $timeout, $location, exModal, $http, $state, StartProcessService) {
        ...
        function getAllTaskNodes() {
            $http.get(baseUrl + '/process-definition/key/Revision/xml')
                .then(function (response) {
                    ...
                    $scope.taskIds.push({
                        id: 'accept_work_maintenance_group',
                        name: 'Accept and sign by maintanance group'
                    });
        ...
        $scope.searchProcessesForContractors = async function (refresh, skipPagination) {
            ...
            } else if ($rootScope.hasGroup('hq_contractor_inter') || $rootScope.hasGroup('astana_contractor_inter') || $rootScope.hasGroup('nc_contractor_inter') || $rootScope.hasGroup('alm_contractor_inter') || $rootScope.hasGroup('east_contractor_inter') || $rootScope.hasGroup('south_contractor_inter') || $rootScope.hasGroup('west_contractor_inter')) {
                $scope.contractorCode = 9;
            ...
            } else if ($rootScope.hasGroup('astana_contractor_lse') || $rootScope.hasGroup('astana_contractor_arlan') || $rootScope.hasGroup('astana_contractor_alta') || $rootScope.hasGroup('astana_contractor_logycom') || $rootScope.hasGroup('astana_contractor_inter')) {
                queryParams.variables.push({"name": "siteRegion", "operator": "eq", "value": 'astana'});
            } else if ($rootScope.hasGroup('nc_contractor_lse') || $rootScope.hasGroup('nc_contractor_arlan') || $rootScope.hasGroup('nc_contractor_alta') || $rootScope.hasGroup('nc_contractor_logycom') || $rootScope.hasGroup('nc_contractor_inter') || $rootScope.hasGroup('nc_contractor_antares')) {
                queryParams.variables.push({"name": "siteRegion", "operator": "eq", "value": 'nc'});
            } else if ($rootScope.hasGroup('alm_contractor_lse') || $rootScope.hasGroup('alm_contractor_arlan') || $rootScope.hasGroup('alm_contractor_alta') || $rootScope.hasGroup('alm_contractor_logycom') || $rootScope.hasGroup('alm_contractor_inter') || $rootScope.hasGroup('alm_contractor_avrora') || $rootScope.hasGroup('alm_contractor_antares') || $rootScope.hasGroup('alm_contractor_vostok')) {
                queryParams.variables.push({"name": "siteRegion", "operator": "eq", "value": 'alm'});
            } else if ($rootScope.hasGroup('east_contractor_lse') || $rootScope.hasGroup('east_contractor_arlan') || $rootScope.hasGroup('east_contractor_alta') || $rootScope.hasGroup('east_contractor_logycom') || $rootScope.hasGroup('east_contractor_inter')) {
                queryParams.variables.push({"name": "siteRegion", "operator": "eq", "value": 'east'});
            } else if ($rootScope.hasGroup('south_contractor_lse') || $rootScope.hasGroup('south_contractor_arlan') || $rootScope.hasGroup('south_contractor_alta') || $rootScope.hasGroup('south_contractor_logycom') || $rootScope.hasGroup('south_contractor_inter') || $rootScope.hasGroup('south_contractor_antares') || $rootScope.hasGroup('south_contractor_nurtrans') || $rootScope.hasGroup('south_contractor_vostok')) {
                queryParams.variables.push({"name": "siteRegion", "operator": "eq", "value": 'south'});
            } else if ($rootScope.hasGroup('west_contractor_lse') || $rootScope.hasGroup('west_contractor_arlan') || $rootScope.hasGroup('west_contractor_alta') || $rootScope.hasGroup('west_contractor_logycom') || $rootScope.hasGroup('west_contractor_inter') || $rootScope.hasGroup('west_contractor_nurtrans')) {
        ...
        function ($scope, $rootScope, $filter, $http, $state, $stateParams, $q, $location, AuthenticationService) {
            ...
            $scope.downloadFinancialReportVostok2023 = function () {
                if ($rootScope.hasGroup('revision_reports')) {
                    $http.get('/camunda/reports/financialreportvostok2023').then(function (response) {
                        var data = response.data;
                        angular.forEach(data, function (d) {
                        ...
                        data.splice(0, 0, ["Contract", "Year", "Month", "Region", "Oblast", "Sitename", "JR No", "JR To", "JR Reason", "Requested Date", "Requested By", "Validity Date",
                            "Work start date", "Integration run date", "Work completion date", "Project"
                            ...
                            , "Materials from", "Comments", "Customer Material", "Process State", "JR Status", "Detailed status", "Reason", "Price (without transportation)"
                            , "Price (with transportation)", "Price (discount)", "Monthly act #", "JO#", "PR", "PO", "CM", "AVR", "ESF", "AVR date", "ESF date", "IR"]);
                        ...
                        return XLSX.writeFile(wb, 'vostok2023-extended-report-by-works.xlsx');
                    });
                }
            }
            $scope.downloadFinancialReportOpenTender2023 = function () {
                if ($rootScope.hasGroup('revision_reports')) {
                    $http.get('/camunda/reports/financialreportopentender2023').then(function (response) {
                        var data = response.data;
                        angular.forEach(data, function (d) {
                            d[9] = $filter('date')(d[9], "dd-MM-yyyy");
                            d[11] = $filter('date')(d[11], "dd-MM-yyyy");
                        ...
                        return XLSX.writeFile(wb, 'ot2023-extended-report-by-works.xlsx');
                    });
                }
            }
            $scope.downloadFinancialReportPS2023 = function () {
                if ($rootScope.hasGroup('revision_reports')) {
                    $http.get('/camunda/reports/financialreportps2023').then(function (response) {
                        var data = response.data;
                        angular.forEach(data, function (d) {
                            d[9] = $filter('date')(d[9], "dd-MM-yyyy");
                            d[11] = $filter('date')(d[11], "dd-MM-yyyy");
                        ...
                        return XLSX.writeFile(wb, 'ps2023-extended-report-by-works.xlsx');
                    });
                }
            }
            ...
            $scope.downloadExtendedByJobsReportVostok2023 = function () {
                if ($rootScope.hasGroup('revision_reports')) {
                    $http.get('/camunda/reports/extended-report-by-jobs-vostok-2023').then(function (response) {
                        var data = response.data;
                        ...
                        data.splice(0, 0, ["Contract", "Year", "Month", "Region", "Oblast", "Sitename", "JR No", "JR To", "JR Reason", "Requested Date", "Requested By", "Validity Date",
                            ...
                            , "Comments", "Customer Material", "Process State", "JR Status", "Detailed status", "Reason", "Price (without transportation)"
                            , "Price (with transportation)", "Price (discount)", "Monthly act #", "JO#", "Job list", "PR", "PO", "CM", "AVR", "ESF", "AVR date", "ESF date", "IR"
                        ]);

                        var ws = XLSX.utils.json_to_sheet(response.data, {skipHeader: true});
                        var wb = XLSX.utils.book_new();
                        XLSX.utils.book_append_sheet(wb, ws, 'New Sheet Name 1');
                        return XLSX.writeFile(wb, 'vostok2023-extended-report-by-jobs.xlsx');
                    });
                }
            }
            $scope.downloadExtendedByJobsReportOpenTender2023 = function () {
                if ($rootScope.hasGroup('revision_reports')) {
                    $http.get('/camunda/reports/extended-report-by-jobs-open-tender-2023').then(function (response) {
                        var data = response.data;
                        ...
                        var wb = XLSX.utils.book_new();
                        XLSX.utils.book_append_sheet(wb, ws, 'New Sheet Name 1');
                        return XLSX.writeFile(wb, 'ot2023-extended-report-by-jobs.xlsx');
                    });
                }
            }
            $scope.downloadExtendedByJobsReportPS2023 = function () {
                if ($rootScope.hasGroup('revision_reports')) {
                    $http.get('/camunda/reports/extended-report-by-jobs-ps-2023').then(function (response) {
                        var data = response.data;
                        ...
                        var wb = XLSX.utils.book_new();
                        XLSX.utils.book_append_sheet(wb, ws, 'New Sheet Name 1');
                        return XLSX.writeFile(wb, 'ps2023-extended-report-by-jobs.xlsx');
                    });
                }
            }
            ...
            $scope.downloadExtendedByJobsReport2022 = function () {
                if ($rootScope.hasGroup('revision_reports')) {
                    $http.get('/camunda/reports/extended-report-by-jobs2022').then(function (response) {
                        var data = response.data;
        ...
        }]).controller('PowerRevisionStatisticsCtrl', ['$scope', '$rootScope', '$filter', '$http', '$state', '$stateParams', '$q', '$location', 'AuthenticationService',
        function ($scope, $rootScope, $filter, $http, $state, $stateParams, $q, $location, AuthenticationService) {
            ...
            $scope.downloadExtendedByWorksReport = function () {
                if ($rootScope.hasGroup('revision power_report')) {
                    $http.get('/camunda/reports/power-extended-financial-report-by-works').then(function (response) {
                        ...
                        return XLSX.writeFile(wb, 'RP-extended-report-by-works.xlsx');
                    });
                }
            }
            ...
            $scope.downloadExtendedByJobsReport = function () {
                if ($rootScope.hasGroup('revision power_report')) {
                    $http.get('/camunda/reports/power-extended-financial-report-by-jobs').then(function (response) {
                        var data = response.data;
                        ...
                        var wb = XLSX.utils.book_new();
                        XLSX.utils.book_append_sheet(wb, ws, 'New Sheet Name 1');
                        return XLSX.writeFile(wb, 'RP-extended-report-by-jobs.xlsx');
                    });
                }
            }
        ...
        function ($scope, $rootScope, $filter, $http, $state, $stateParams, $q, $location, AuthenticationService) {
            ...
            if (true) {
                ...
                $scope.generalStatuses = [
                    ...
                    {
                        id: 'Provisional approval by Power, Transmission & Leasing',
                        name: 'Provisional approval',
                        substatuses: [
                            {id: 'Waiting regional Power approval', name: 'Waiting regional Power approval'},
                            {
                                id: 'Waiting regional Transmission approval',
                                name: 'Waiting regional Transmission approval'
                            },
                ...
                $scope.init = function () {
                    ...
                    if ($scope.project) {
                        ncpRejectedProcessQuery.variables = [{
